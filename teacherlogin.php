        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="./teacherlogin.php">Class Teacher Login</a>
                    </li>
                </ul>
    ...
    <section class="admin-form">
        <div class="container py-5">
            <div class="row g-4 py-5">
                <div class="col-md-7">
                    <div class="card">
                        <img src="./img/a1.png" class="card-img-top" alt="Image Not Found">
                    </div>

                </div>
                <div class="col md-5">
                    <div class="card h-100 w-100">
                        <h1 class="text-center mt-5">Class Teacher Login</h1>
                        <hr class="ml-3 mr-3">
                        <?php
